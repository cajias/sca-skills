...
```txt
agentic-guardrails @ git+https://github.com/cajias/lint-configs.git@v1.0.1#subdirectory=python
```
...
Want to make it available via `pip install agentic-guardrails` (without git URL)?
